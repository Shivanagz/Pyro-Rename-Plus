...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("🤖 SOURCE CODE", url="https://github.com/Shivanagz/Pyro-Rename-Plus")
        ],[
...
async def start(bot, msg, cb=True):   
    txt=f"hai {msg.from_user.mention} i am simple rename bot with personal usage.\nthis bot is made by <b><a href=https://github.com/Shivangz>Shivanagz</a></b>"                                     
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/PilotGalaxy")
        ],[
